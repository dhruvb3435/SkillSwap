...
router.post('/register', (0, validate_1.validateBody)(dto_1.RegisterSchema), async (req, res, next) => {
    try {
...
router.post('/login', (0, validate_1.validateBody)(dto_1.LoginSchema), async (req, res, next) => {
    try {
